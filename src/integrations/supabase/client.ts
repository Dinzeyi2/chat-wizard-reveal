...
// Available methods:
// - supabase.from('table_name').select('*') - Query data from a table
// - supabase.functions.invoke('function-name', { body: {} }) - Call edge functions
// - supabase.auth.* - Authentication methods
// - supabase.storage.* - Storage methods
